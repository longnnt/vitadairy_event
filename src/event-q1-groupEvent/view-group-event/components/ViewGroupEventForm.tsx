...
export const ViewGroupEventForm = () => {
    ...
    <>
      <HeaderBreadcrumbs
        ...
        links={[
          ...
          { name: BREADCUMBS.VIEW_GROUP_EVENT },
        ]}
      />
      ...
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
          <Box sx={{ pt: 3}}>
            <Stack spacing="26px" >
              <Stack direction={'row'} spacing='26px'>
                ...
                <RHFTextField name="name" label="Tên Group Event*" disabled/>
              </Stack>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: '26px' }}>
          <Stack direction="row" spacing={2}>
            <Button
              variant="contained"
              onClick={() => navigate(PATH_DASHBOARD.eventQ1GroupEvent.editGroupEvent(parseInt(id as string)))}
            >
              Chỉnh sửa
            </Button>
            <Button
